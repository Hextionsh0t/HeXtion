...
if($menge == 0) 
    { 
    $eintrag = "INSERT INTO users (username, password, loginreqkey, status, rank, level, exp, expneeded, banned, mail, gold, sword) VALUES ('$username', '$password','$authkey','offline', 'user', '1', '0', '1000', '', '$email', '1000', '1')"; 
